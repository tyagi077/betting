...
function TotalBet() {
  ...
  return (
    <div className="flex flex-col text-white gap-8">
      <h1 className="text-3xl font-semibold">User bet history</h1>
      ...
      <div className="bg-[#0e1726] py-3 px-5 rounded-lg ">
        <div className="filterData flex flex-col gap-6 md:w-[70%] xl:w-[50%]">
          <div className="flex items-center gap-4">
            ...
            <div className="flex flex-col gap-2">
              <p>Time slot</p>
              <select name="time" id="timeSelect" onChange={(e) => e.target.value} className="bg-[#1A1B2D] py-1 px-3 w-[10rem]"                            >
                <option value={""}>Choose...</option>
                {category?.map((cat, index) => (
                  <option key={index} value={cat?.ename}>
                    {cat?.ename}
            ...
            <div className="flex flex-col gap-2">
              <p>type</p>
              <select name="type" id="typeSelect" onChange={(e) => e.target.value} className="bg-[#1A1B2D] py-1 px-3 w-[10rem]"                            >
                <option value={""}>Choose...</option>
                {category?.map((cat, index) => (
                  <option key={index} value={cat?.ename}>
                    {cat?.ename}
            ...
            <div className="flex flex-col gap-2">
              <p>Mobile Number</p>
              <input type="number" placeholder="Enter Mobile Number" id="todayDate" className="bg-[#1A1B2D] py-1 px-3" />
            </div>
            <div className="flex flex-col gap-2">
              <p>Date</p>
