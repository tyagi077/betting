...
function News() {
    ...
    const fetchData = async () => {
        axios.get(`${import.meta.env.VITE_BACKEND_URL}/news/display.php`)
            .then(res => {
                setData(res.data);
            })
    ...
    return (
        <div className='flex flex-col gap-4 text-white'>
            ...
            <Link to={`/add/news`}><button className='btn btn1'><i className="fa-solid fa-plus"></i> Add</button></Link>
                    ...
                    <table className="data-table" id="dataTable">
                        <thead>
                            <tr>
                                ...
                                <th onClick={() => sortTable(2)}>desc</th>
                                ...
                                newData?.splice(startIndex, endIndex).map((obj, index) => (
                                    <tr key={index}>
                                        ...
                                        <td className="">
                                            ...
                                            <Link to={`/update/news/${obj.id}`}><i className="updateFormBtn cursor-pointer hover:text-white text-[#dcdada] fa-regular fa-pen-to-square bg-[#406793] p-2 rounded-lg "></i></Link>
