...
function DeductBalance() {
  ...
  const submit = () => {
    if(form.phone && form.balance){
      ...
      axios.post(`${import.meta.env.VITE_BACKEND_URL}/balance/deductbalance.php`, formData, {
        headers: {
  ...
  return (
    <div className=' w-full'>
      <div className="addUser w-[90%] flex flex-col gap-4">
        <h1 className='text-3xl text-white font-semibold'>deduct Account</h1>
        <Input handleChange={handleChange} name="phone" label="Phone No." />
        <Input handleChange={handleChange} name="balance" label="Balance Amount" />
