...
function WinningPrice() {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get(`${import.meta.env.VITE_BACKEND_URL}/cp_digits/display.php`);
    ...
    const handleFilter = () => {
        if (inputValue) {
            let filtered = data.filter(news =>
                news.digit.toUpperCase().includes(inputValue.toUpperCase())
            );
    ...
    const deleteData = async (id) => {
        try {
            const response = await axios.get(`${import.meta.env.VITE_BACKEND_URL}/cp_digits/delete.php?deleteid=${id}`);
    ...
    return (
        <div className='flex flex-col gap-4 text-white'>
            ...
            <div className="bg-[#0e1726] py-3 px-5 rounded-lg ">
                ...
                <Link to={`/add/cpdigit`}><button className='btn btn1'><i className="fa-solid fa-plus"></i> Add</button></Link>
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center ">
                        ...
                        <input type="text" onChange={e => setInputValue(e.target.value)} placeholder="Filter by digit..." className='bg-[#07081C] w-[15rem] py-1 px-2 rounded-lg' />
                    </div>
                ...
                <div className="table-container">
                    ...
                    <table className="data-table" id="dataTable">
                        <thead>
                            <tr>
                                <th onClick={() => sortTable(0)}>Digit</th>
                                ...
                                newData?.splice(startIndex, endIndex).map((obj, index) => (
                                    <tr key={index}>
                                        ...
                                        <td className="">
                                            ...
                                            <Link to={`/update/cpdigit/${obj.id}`}><i className="updateFormBtn cursor-pointer hover:text-white text-[#dcdada] fa-regular fa-pen-to-square bg-[#406793] p-2 rounded-lg "></i></Link>
